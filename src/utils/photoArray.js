...
export const artArr = {
  photos: [

    {
      ...
      url: 'https://ko-fi.com/s/f86e18dd03',
      description:
        "Photo of black-capped chickadee taken spring 2023 in Spokane.",
    },
    {
      names: ["Hoco-1.webp", "Rock Face.webp"],
    ...
    {
      names: [
        "Subtle Anarchy 2.webp",
        "Subtle Anarchy-1.webp",
        "Subtle Messages.webp",
      ],
      url: 'https://ko-fi.com/s/5bc3593be3',
      description:
    ...
    },
    {
      ...
      url: 'https://ko-fi.com/s/de2c7b619f',
  ...
  digitalArt: [
    ...
    {
      names: ["Fall Feelings 1080p.webp"],
      url: 'https://ko-fi.com/s/fdbde88901',
      description: "'Fall Feelings' made on Procreate"
    },
    {
      names: ["Just a little greener small.webp", "Just a little greener var.webp"],
